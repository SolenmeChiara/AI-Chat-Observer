...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <div className={`fixed inset-y-0 right-0 w-full sm:w-80 bg-white dark:bg-zinc-900 shadow-2xl border-l border-gray-200 dark:border-zinc-700 transform transition-transform duration-300 z-50 overflow-hidden flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      {/* Agents List */}
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50/50 dark:bg-black/50 space-y-3 relative">

        {/* USER PROFILE SWITCHER - First in list */}
        {userProfiles && onSwitchProfile && (
          <div className={`bg-white dark:bg-zinc-900 p-3 rounded-xl border shadow-sm relative transition-all hover:shadow-md ${
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-2 py-1 text-[10px] bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-zinc-600 transition-colors flex items-center gap-1"
              >
                  ...
                  <button
                    ...
                    className={`flex-1 py-1.5 text-xs font-medium rounded-lg transition-colors ${
                      !isDebateMode
                        ...
                        : 'bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
                    }`}
                  >
                    {t('随机')}
                  </button>
                ...
                {!isDeleteMode && (
                  <div className="flex flex-col gap-1">
                    <button
                      ...
                      className={`px-2 py-1 text-[10px] rounded transition-colors flex items-center gap-1 ${isAdmin ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 hover:bg-amber-200 dark:hover:bg-amber-900/50' : 'bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'}`}
                    >
                    ...
                    {onToggleMentionOnly && (
                      <button
                        ...
                        className={`px-2 py-1 text-[10px] rounded transition-colors flex items-center gap-1 ${isMentionOnly ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-900/50' : 'bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'}`}
                      >
                        <AtSign size={10} />
                    ...
                    {isMuted ? (
                      ...
                      <button
                        ...
                        className="px-2 py-1 text-[10px] bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-zinc-600 transition-colors"
                      >
                        {t('禁言')}
                      </button>
                    )}
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 dark:border-zinc-700">
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-[10px] bg-zinc-900 dark:bg-zinc-700 text-white rounded hover:bg-black dark:hover:bg-zinc-500 transition-colors"
                    >
                      {t('自定义')}
                    </button>
                  </div>
                      ...
                      {agents.filter(a => a.id !== agent.id).map(otherAgent => {
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            <img src={otherAgent.avatar} className="w-4 h-4 rounded-full bg-white object-contain border border-gray-200 dark:border-zinc-700" />
